...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      { path: '', redirect: '/home' },
      { path: 'home', component: () => import('@/views/customer/HomeView.vue'), meta: { requiresAuth: true, requiresCustomer: true } },
      ...
      { path: 'products/:id', component: () => import('@/views/customer/ProductDetailView.vue') },
      { path: 'cart', component: () => import('@/views/customer/CartCheckoutView.vue'), meta: { requiresAuth: true, requiresCustomer: true } },
      ...
      { path: 'membership', component: () => import('@/views/customer/MembershipRewardsView.vue'), meta: { requiresAuth: true, requiresCustomer: true } },
      ...
      { path: 'news', component: () => import('@/views/customer/NewsView.vue') },
